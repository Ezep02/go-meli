...
func GenerateToken(user_id uint, isAdmin bool, name string, email string, surname string) (string, error) {
...
func VerfiyToken(tokenString string) (*models.VerifyTokenRes, error) {
